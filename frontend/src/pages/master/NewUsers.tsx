      ...
      <div className="h-full w-full overflow-auto border-[1px] dark:border-gray-700">
        <table className="text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              <th className="w-[400px] py-3 px-6 text-center sticky left-0 top-0 z-[3]  bg-gray-50 dark:bg-gray-700 ">
                Action
              </th>
              <th className="min-w-[100px] py-3 px-6 sticky left-0 top-0 z-[3] bg-gray-50 dark:bg-gray-700 ">
                Sl No
              </th>
              <th className="min-w-[250px] py-3 px-6 sticky left-0 top-0 z-[3] text-center bg-gray-50 dark:bg-gray-700 ">
                Employee ID
              </th>
              <th className="min-w-[250px] py-3 px-6 sticky left-0 top-0 z-[3] text-center bg-gray-50 dark:bg-gray-700 ">
                Name
              </th>
              <th className="min-w-[200px] py-3 px-6 sticky left-0 top-0 z-[3] text-center  bg-gray-50 dark:bg-gray-700 ">
                Email
              </th>
              <th className="min-w-[200px] py-3 px-6 sticky left-0 top-0 z-[3] text-center  bg-gray-50 dark:bg-gray-700 ">
                Mobile
