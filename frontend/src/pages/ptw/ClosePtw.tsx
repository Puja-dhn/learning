...
} from "@/features/ptw/services/ptw.services";
...
import ILogPTWCloseForm from "@/features/ptw/types/ptw/ILogPTWCloseForm";
...
const initialApproveValues: ILogPTWCloseForm = {
  id: 0,
  closure_remarks: "",
};
...
function ClosePtw() {
  ...
  const handleApproveFormSubmit: SubmitHandler<ILogPTWApproveForm> = (
    ...
    closePtw(values)
      .then(() => {
        alertToast.show("success", "Permit Closed Successfully", true, 2000);
